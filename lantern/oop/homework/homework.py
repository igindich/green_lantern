class Cat:
    ...
    * Implement get_average_speed and return average_speed
    ...
    # Add  to
    #
    # class average_speed variable which will get it's values
    #
    # from private method
    # _set_average_speed()
    ...
    def __init__(self, age):
        self.age = age
        self.avarage_speed = self._set_average_speed()
    ...
    # private
    # methods
    # _increase_saturation_level and _reduce_saturation_level
    # that
    # will
    # receive
    # value and add / subtract
    # from saturation_level this
    # value
    # if saturation_level is less than 0, return 0
    # if saturation_level is grosser than 100, return 100
    ...
    # *Implement
    # get_average_speed and
    # return average_speed

    def get_average_speed(self):
        return self.avarage_speed
...
class Cheetah(Cat):
    ...
    * Redefine method _set_average_speed
    ...
    def _set_average_speed(self):
        if self.age <= 5:
            return 90
        elif self.age <= 15 and self.age > 5:
            return 75
        elif self.age > 15:
            return 40
    ...
    def roof_square(self):
        if self.roof_type == "gable":
            ...
            try:
                ...
                return "Sorry there is only two types of roof"
